...
// Константа используется и проверкой hasActiveTrade в trades.ts: приглашение
// старше этого порога не считается "активным" и не блокирует новые обмены.
export const TRADE_STALE_MINUTES = 10;
