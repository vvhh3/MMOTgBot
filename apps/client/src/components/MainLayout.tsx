            ...
            <div className="flex flex-row w-full justify-around shadow-[0_4px_20px_rgba(0,0,0,0.15)] h-20 shrink-0 border-t-2" style={{ paddingBottom: "var(--tg-safe-area-inset-bottom, 0px)", }} >
                <Link to="/">
                    <div className=" flex flex-col justify-center items-center h-20 w-16.25">
                        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path fillRule="evenodd" clipRule="evenodd" d="M21.4498 10.275L11.9998 3.1875L2.5498 10.275L2.9998 11.625H3.7498V20.25H20.2498V11.625H20.9998L21.4498 10.275ZM5.2498 18.75V10.125L11.9998 5.0625L18.7498 10.125V18.75H14.9999V14.3333L14.2499 13.5833H9.74988L8.99988 14.3333V18.75H5.2498ZM10.4999 18.75H13.4999V15.0833H10.4999V18.75Z" fill="#8A7A60"></path></g></svg>                        <p className="text-[13px] font-normal text-[#8A7A60]">Главная</p>
                    </div>
                </Link>
                <Link to="/Tasks">
                    <div className=" flex flex-col justify-center items-center h-20 w-16.25">
