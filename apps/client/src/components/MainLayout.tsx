...
export default function MainLayout({player}: LayoutProps){
    ...
    return(
        <div className="flex flex-col w-full overflow-hidden" style={{height: "var(--tg-viewport-stable-height, 100dvh)",}}>
            ...
            <div className="flex flex-row justify-around shadow-[0_4px_20px_rgba(0,0,0,0.15)] h-20 shrink-0 border-t-2"style={{paddingBottom: "var(--tg-safe-area-inset-bottom, 0px)",}} >
                <Link to="/">
                    <div className=" flex flex-col justify-center items-center h-20 w-16.25">
                        {/* <svg className="h-7.5 w-7.5" viewBox="0 0 1024 1024"  version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M242.3 475.1v416.7h162.6V721.5c0-51.4 48.2-93.7 107.1-93.7 58.9 0 107.1 42.3 107.1 93.7v170.2h162.6V475.1H242.3zM683.8 324.4v-88.6c0-12.3 9.9-22.2 22.2-22.2h82.1c12.3 0 22.2 9.9 22.2 22.2v115.4c0 12.3-9.9 22.2-22.2 22.2h-48.8" fill="#ffffff"></path><path d="M788.1 396.4h-48.8c-12.7 0-23-10.3-23-23s10.3-23 23-23h48.1V236.6h-80.6v87.8c0 12.7-10.3 23-23 23s-23-10.3-23-23v-88.6c0-24.9 20.3-45.2 45.2-45.2h82.1c24.9 0 45.2 20.3 45.2 45.2v115.4c0 24.9-20.3 45.2-45.2 45.2z" fill="#8C8C80"></path><path d="M404.9 883.5c-68.7-58-120.5-135-162.6-217.9v226.2h162.6v-8.3z" fill="#ffffff"></path><path d="M781.7 914.7H619.1c-12.7 0-23-10.3-23-23V721.5c0-38.9-37.8-70.5-84.2-70.5s-84.2 31.6-84.2 70.5v170.2c0 12.7-10.3 23-23 23H242.3c-12.7 0-23-10.3-23-23V475.1c0-12.7 10.3-23 23-23h280.8c12.7 0 23 10.3 23 23s-10.3 23-23 23H265.3v370.8H382V721.5c0-64.2 58.3-116.4 130.1-116.4s130.1 52.2 130.1 116.4v147.3h116.7V673.1c0-12.7 10.3-23 23-23s23 10.3 23 23v218.7c-0.3 12.6-10.5 22.9-23.2 22.9z" fill="#8C8C80"></path><path d="M104 482l377.9-344.5c16.6-15.1 43.6-15.1 60.2 0L920 482c25.7 23.4 2.3 57.6-39.3 57.6H143.3c-41.6 0.1-64.9-34.2-39.3-57.6z" fill="#ffffff"></path><path d="M880.7 562.6h-99.2c-12.7 0-23-10.3-23-23s10.3-23 23-23h99.2c15.3 0 24.9-6.8 26.7-11.6 0.3-0.8 1-2.5-3-6.1L535.8 162.8c-11.1-10.1-36.5-10.1-47.6 0L119.5 499c-3.9 3.6-3.3 5.3-3 6.1 1.9 4.8 11.4 11.6 26.8 11.6h99c12.7 0 23 10.3 23 23s-10.3 23-23 23h-99c-32.6 0-59.9-16.1-69.6-40.9-7.7-19.9-2.2-41.1 14.8-56.6L457.2 129c28.6-26.1 80.8-26.1 109.4 0l368.7 336.2c17 15.5 22.6 36.7 14.8 56.6-9.5 24.7-36.8 40.8-69.4 40.8z" fill="#8C8C80"></path></g></svg> */}
                ...
                <Link to="/Tasks">
                    <div className=" flex flex-col justify-center items-center h-20 w-16.25">
                        ...
                        {/* <svg className="h-7.5 w-7.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 10.4V20M12 10.4C12 8.15979 12 7.03969 11.564 6.18404C11.1805 5.43139 10.5686 4.81947 9.81596 4.43597C8.96031 4 7.84021 4 5.6 4H4.6C4.03995 4 3.75992 4 3.54601 4.10899C3.35785 4.20487 3.20487 4.35785 3.10899 4.54601C3 4.75992 3 5.03995 3 5.6V16.4C3 16.9601 3 17.2401 3.10899 17.454C3.20487 17.6422 3.35785 17.7951 3.54601 17.891C3.75992 18 4.03995 18 4.6 18H7.54668C8.08687 18 8.35696 18 8.61814 18.0466C8.84995 18.0879 9.0761 18.1563 9.29191 18.2506C9.53504 18.3567 9.75977 18.5065 10.2092 18.8062L12 20M12 10.4C12 8.15979 12 7.03969 12.436 6.18404C12.8195 5.43139 13.4314 4.81947 14.184 4.43597C15.0397 4 16.1598 4 18.4 4H19.4C19.9601 4 20.2401 4 20.454 4.10899C20.6422 4.20487 20.7951 4.35785 20.891 4.54601C21 4.75992 21 5.03995 21 5.6V16.4C21 16.9601 21 17.2401 20.891 17.454C20.7951 17.6422 20.6422 17.7951 20.454 17.891C20.2401 18 19.9601 18 19.4 18H16.4533C15.9131 18 15.643 18 15.3819 18.0466C15.15 18.0879 14.9239 18.1563 14.7081 18.2506C14.465 18.3567 14.2402 18.5065 13.7908 18.8062L12 20" stroke="#E8603C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg> */}
                        <p className="text-[13px] font-normal text-[#8A7A60]">Задания</p>
                    </div>
                </Link>
                <Link to="/Team">
                    <div className=" flex flex-col justify-center items-center h-20 w-16.25">
                        {/* <svg className="h-7.5 w-7.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="3" stroke="#E8603C" stroke-width="1.5"></circle> <path d="M3.66122 10.6392C4.13377 10.9361 4.43782 11.4419 4.43782 11.9999C4.43781 12.558 4.13376 13.0638 3.66122 13.3607C3.33966 13.5627 3.13248 13.7242 2.98508 13.9163C2.66217 14.3372 2.51966 14.869 2.5889 15.3949C2.64082 15.7893 2.87379 16.1928 3.33973 16.9999C3.80568 17.8069 4.03865 18.2104 4.35426 18.4526C4.77508 18.7755 5.30694 18.918 5.83284 18.8488C6.07287 18.8172 6.31628 18.7185 6.65196 18.5411C7.14544 18.2803 7.73558 18.2699 8.21895 18.549C8.70227 18.8281 8.98827 19.3443 9.00912 19.902C9.02332 20.2815 9.05958 20.5417 9.15224 20.7654C9.35523 21.2554 9.74458 21.6448 10.2346 21.8478C10.6022 22 11.0681 22 12 22C12.9319 22 13.3978 22 13.7654 21.8478C14.2554 21.6448 14.6448 21.2554 14.8478 20.7654C14.9404 20.5417 14.9767 20.2815 14.9909 19.9021C15.0117 19.3443 15.2977 18.8281 15.7811 18.549C16.2644 18.27 16.8545 18.2804 17.3479 18.5412C17.6837 18.7186 17.9271 18.8173 18.1671 18.8489C18.693 18.9182 19.2249 18.7756 19.6457 18.4527C19.9613 18.2106 20.1943 17.807 20.6603 17C20.8677 16.6407 21.029 16.3614 21.1486 16.1272M20.3387 13.3608C19.8662 13.0639 19.5622 12.5581 19.5621 12.0001C19.5621 11.442 19.8662 10.9361 20.3387 10.6392C20.6603 10.4372 20.8674 10.2757 21.0148 10.0836C21.3377 9.66278 21.4802 9.13092 21.411 8.60502C21.3591 8.2106 21.1261 7.80708 20.6601 7.00005C20.1942 6.19301 19.9612 5.7895 19.6456 5.54732C19.2248 5.22441 18.6929 5.0819 18.167 5.15113C17.927 5.18274 17.6836 5.2814 17.3479 5.45883C16.8544 5.71964 16.2643 5.73004 15.781 5.45096C15.2977 5.1719 15.0117 4.6557 14.9909 4.09803C14.9767 3.71852 14.9404 3.45835 14.8478 3.23463C14.6448 2.74458 14.2554 2.35523 13.7654 2.15224C13.3978 2 12.9319 2 12 2C11.0681 2 10.6022 2 10.2346 2.15224C9.74458 2.35523 9.35523 2.74458 9.15224 3.23463C9.05958 3.45833 9.02332 3.71848 9.00912 4.09794C8.98826 4.65566 8.70225 5.17191 8.21891 5.45096C7.73557 5.73002 7.14548 5.71959 6.65205 5.4588C6.31633 5.28136 6.0729 5.18269 5.83285 5.15108C5.30695 5.08185 4.77509 5.22436 4.35427 5.54727C4.03866 5.78945 3.80569 6.19297 3.33974 7C3.13231 7.35929 2.97105 7.63859 2.85138 7.87273" stroke="#E8603C" stroke-width="1.5" stroke-linecap="round"></path> </g></svg> */}
